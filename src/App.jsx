      ...
      <div className="w-full md:w-1/2 bg-slate-900 text-white flex flex-col justify-center items-center p-8 relative overflow-hidden">
        ...
        <div className="z-10 w-full max-w-md flex flex-col gap-8">
          <div className="space-y-2">
            <h1 className="text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-indigo-400">
              Note App
            </h1>
            <p className="text-gray-400 text-lg">Capture your thoughts instantly.</p>
          </div>

          <form onSubmit={handleAddNote} className="contents">
            <div className="relative group">
              ...
              <textarea
                ...
                className="relative w-full h-64 bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none shadow-2xl transition-all duration-300"
            ...
            <button
              ...
              className="relative px-8 py-4 bg-linear-to-r from-blue-600 to-indigo-600 rounded-xl font-semibold text-lg hover:from-blue-500 hover:to-indigo-500 transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2 group w-full sm:w-auto self-start cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none">
              Add Note
